...
public class C03_KeyDown_KeyUp extends TestBase {
    ...
    public void test01() {
        ...
        //arama kutusunda shift tusuna basılı olarak selenim yazdıralım ve shift tuşunu serbest bırakarak java yazdıralımWebElement aramaKutusu = driver.findElement(By.id("APjFqb"));
    ...
    public void test03() {
        ...
        driver.findElement(By.xpath("(//input[@class=\"gNO89b\"])[2]")).click();// google arama enter
        ...
        driver.findElement(By.xpath("//*[@class='gLFyf']")).sendKeys(Keys.CONTROL,"v");
        driver.findElement(By.xpath("(//input[@class=\"gNO89b\"])[2]")).click();// google arama enter
